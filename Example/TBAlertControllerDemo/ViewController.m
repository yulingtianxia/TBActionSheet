...
- (IBAction)clickActionSheet:(UIButton *)sender {
    TBActionSheet *actionSheet = [[TBActionSheet alloc] initWithTitle:@"八爪鱼" message:@"ddd" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:@"销毁" otherButtonTitles:@"点我", nil];
